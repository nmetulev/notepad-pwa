 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function G(t,e){const o=E({waitUntilFirstUpdate:!1},e);return(i,r)=>{const{update:s}=i;if(t in i){const n=t;i.update=function(a){if(a.has(n)){const l=a.get(n),c=this[n];l!==c&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[r](l,c)}s.call(this,a)}}}}var y=t=>t!=null?t:A;/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
//# sourceMappingURL=index.cb203e1c.js.map
